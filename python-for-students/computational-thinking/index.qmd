...
subtitle: think with algorithms, data, and logic
jupyter: python3
order: 2
format:
  html:
...
- **Decomposition**, or breaking down a problem into smaller, more manageable parts - for exampling, planning a trip involves breaking it down into smaller tasks like booking flights, finding accommodation, and planning activities.
- **Pattern recognition**, or identifying similarities and trends which might help solve a problem - for example, analyzing sales data might reveal that certain products sell better during specific times of the year.
- **Abstraction**, or focusing on the critical details of a problem, while ignoring less relevant information to create a simplified, more general model - for example, creating a map of a city that only shows major roads and landmarks, rather than every single building.
- **Algorithm or problem-solving steps** that can be repeated to solve similar problems - for example, following a flowchart to troubleshoot a technical issue.
...
It is estimated that by 2025, the world will produce [463 exabytes of data every day](https://www.weforum.org/stories/2019/04/how-much-data-is-generated-each-day-cf4bddf29f/). Your day to day interactions with technology, social media and the internet could very well produce more recorded data than the whole of the Roman Empire did in its entire existence!
...
The second is to always be aware of the context in which data is collected. Data can be biased, incomplete, or misleading, so it is essential to understand where it comes from and how it was collected. For example, a survey conducted only among young people might not be representative of the entire population. Equally, bias can be introduced by the way questions are asked, or by the way data is collected and you can safely assume that all data has some level of bias! There are [many forms of cognitive bias](https://en.wikipedia.org/wiki/List_of_cognitive_biases), and in any given day you will be exposed to at least a handful of them - becoming a critical thinker and problem solver means being able to identify and mitigate these biases.

![Cognitive biases](figures/biases-meme.jpg)
...
If you are starting, often the easiest tool is just to use a spreadsheet like Microsoft Excel or [Google Sheets](https://sheets.google.com). These tools are user-friendly, widely available, and can handle a wide range of data analysis tasks. They are also great for visualizing data, creating charts and graphs, and sharing your findings with others. Learning how to [pivot tables](https://coefficient.io/guide-to-using-pivot-tables-in-google-sheets), use [statistical functions](https://docs.google.com/spreadsheets/d/1jiEmRhTcQpI4JfSckA7RLOv55J0h_Fmps9XRN6ZOEMA/edit?gid=1#gid=1), and create visualizations in a spreadsheet will be a valuable skill for anyone learning computational thinking.

If you are a bit more adventurous, you might want to look into alternative tabular data tools like [row zero](https://rowzero.io/), [Sigma](https://www.sigmacomputing.com/), or Google's [BigQuery](https://cloud.google.com/bigquery). These tools are more powerful and flexible than traditional spreadsheets, and can handle larger datasets, more complex queries, and more advanced analyses.
