...
BLOG_AUTHOR = "Pedro Leitao"  # (translatable)
BLOG_TITLE = "Pedro's Experiments"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://pedro-leitao.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://pedro-leitao.github.io/"
BLOG_EMAIL = ""
BLOG_DESCRIPTION = "This is Pedro's personal space for experimentation and thoughts."  # (translatable)
